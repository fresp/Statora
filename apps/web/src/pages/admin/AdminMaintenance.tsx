        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="text-left px-6 py-3 font-medium text-gray-600">Visibility</th>
            ...
            {viewing.components.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {viewing.components.map((id) => {
                  ...
                  return (
                    <span key={id} className="rounded border border-slate-200 bg-slate-100 px-2 py-1 font-mono text-xs text-slate-600">
                      {comp?.name || id}
                    </span>
                  )
                })}
